...
<div class="container">    
    ...
    <form action="{{route("comics.store")}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('original_title') is-invalid @enderror" id="original_title" name="original_title" placeholder="Inserisci il titolo originale" value="{{old("original_title")}}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('number') is-invalid @enderror" id="number" name="number" placeholder="Inserisci il numero del fumetto" value="{{old("number")}}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('n_pages') is-invalid @enderror" id="n_pages" name="n_pages" placeholder="Inserisci il numero di pagine" value="{{old("n_pages")}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('edition') is-invalid @enderror" id="edition" name="edition" placeholder="Inserisci l'edizione" value="{{old("edition")}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('cover') is-invalid @enderror" id="cover" name="cover" placeholder="Inserisci l'url della copertina" value="{{old("cover")}}">
